...
const downInArray = ({nameKey, key, array}) =>{
    const idx = array.findIndex((el)=>el[nameKey]===key);
...
const upInArray = ({nameKey, key, array}) =>{
    const idx = array.findIndex((ex)=>ex[nameKey]===key);
